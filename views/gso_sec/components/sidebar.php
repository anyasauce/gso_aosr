...
<nav id="sidebar" class="fixed inset-y-0 left-0 z-30 w-[280px] min-h-screen bg-gradient-to-br from-slate-800 to-indigo-900 text-white shadow-lg flex flex-col p-4 -translate-x-full transition-transform duration-300 ease-in-out lg:static lg:translate-x-0">
