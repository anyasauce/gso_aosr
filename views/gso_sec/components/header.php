...
<nav class="flex items-center justify-between px-4 py-3 bg-white/95 backdrop-blur border-b border-gray-100">
    <div class="flex items-center">
        <button id="sidebar-toggle" class="text-gray-800 hover:text-indigo-600 lg:hidden">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"/>
            </svg>
        </button>
        
        <a href="#" class="hidden lg:flex items-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors ml-4">
    ...
    <div class="flex items-center space-x-4">
        ...
        <a href="../../controllers/Logout.php" class="text-red-500 hover:text-red-600 transition-transform hover:translate-x-0.5" title="Logout">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 16 16">
