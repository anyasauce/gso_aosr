...
<body class="bg-slate-50">
        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="flex-1 p-6 lg:p-10">
                ...
                <div class="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden">
                    <table id="GSORequestTable" class="min-w-full text-left">
    ...
    $(document).ready(function () {
        ...
        $('.details-btn').on('click', function () {
            ...
            mapContainer.addClass('hidden'); // Hide map initially
            modalFooter.empty(); // Clear old buttons
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        if (data.res_type === 'place') {
                            ...
                            // For vehicles, we show the map instead of text
                            mapContainer.removeClass('hidden');
                            // We need a slight delay to ensure the modal is visible before initializing the map
                            setTimeout(() => initializeDetailMap(data.latitude, data.longitude), 100);
                        }
                        
                        // Build the HTML for text details
                        ...
                        // Dynamically add Approve/Reject buttons to the modal footer
    ...
    setTimeout(() => detailMap.invalidateSize(), 500);
        ...
        const table = $('#GSORequestTable').DataTable({
