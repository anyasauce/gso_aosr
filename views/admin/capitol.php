        ...
        <div class="flex flex-col flex-1 h-screen overflow-y-auto">
            ...
            <main class="p-4 sm:p-6 md:p-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Capitol Office Requests</h1>
                    </div>
                        ...
                        <table id="capitolTable" class="min-w-full text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <?php
                                    ...
                                    echo "<tr><td colspan='5' class='text-center py-10 text-gray-500'>No capitol office requests found.</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
